        ...
        <>
            ...
            >
                <motion.div className="flex flex-row space-x-6">
                    <a href="https://facebook.com/abrahamdomenick">
                    ...
                    <a href="https://twitter.com/abrahamdomenik">
                        <svg
                    ...
                    <a href="https://instagram.com/abrahamdominik">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                            data-color="#8a3ab9"
                    ...
                    <motion.div>
                        <ul className="text-white flex flex-col space-y-4 justify-end items-center font-circular-std-book font-medium nav">
                            ...
                            <li className="nav-li s-link" data-text="BLOG">
                                <a href="https://abrahamdominic.hashnode.dev" target="_blank">Blog</a>
                            </li>
